      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end p-2" id="navbarNav">
          <ul class="navbar-nav" > 
            ...
            <li class="nav-item">
              <a class="nav-link" href="#" style="margin-left: 0.25cm;margin-right: 0.25cm;color: black;"><b><?= $class3; ?></b></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" style="margin-left: 0.25cm;margin-right: 0.3cm;color: black;"><b><?= $class4; ?></b></a>
            </li>
          </ul>
